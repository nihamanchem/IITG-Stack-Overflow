...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center z-10 justify-between w-screen py-1 px-7 shadow-md fixed border-t-4 border-yellow-500" style={{ backgroundColor: "#FAFAFB" }}>
      ...
      <div className="flex items-center w-1/2 ">
        ...
        <img src="https://image.flaticon.com/icons/png/512/622/622669.png" alt="search" className="w-7 h-7 mx-2"/>
      </div>
