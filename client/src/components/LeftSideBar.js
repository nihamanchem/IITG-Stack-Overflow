  ...
  return (
    <div className="w-72 fixed z-0 border-gray-300 border-r h-screen text-right pl-32 pt-20 ">
      <div className="my-2">
        ...
        activeClassName="border-red-400 border-r-4 text-gray-800 bg-gray-100 font-bold">Home</NavLink>
      ...
      <div className="w-40 border-gray-300 text-right">
        <div>
          ...
          activeClassName="border-red-400 text-gray-800 border-r-4 bg-gray-100 font-bold">Questions</NavLink>
        </div>
        <NavLink exact to="/users" className="text-sm text-gray-500 pl-2 pr-28 py-2 pt-2 items-center flex"
        activeClassName="border-red-400 text-gray-800 border-r-4 bg-gray-100 font-bold">Users</NavLink>
      </div>
    </div>
  );
};
