...
export const voteQAPI = (question_id, voteType) => API.patch("/question/vote/" + question_id, { voteType });
...
export const voteAnsAPI = (answer_id, voteType) => API.patch("/answer/vote/" + answer_id, { voteType });
